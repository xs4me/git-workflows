...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&Config.AuthorUsername, "author-user", "argo-ci", "username for git operations")
	rootCmd.PersistentFlags().StringVar(&Config.AuthorEmail, "author-email", "argo-ci@gepardec.com", "email for git operations")
